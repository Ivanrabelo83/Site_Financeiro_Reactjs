    ...
    <div className="max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300">
      <div>
        ...
        <p className="py-4">
          ...
          laudantium non laboriosam nobis quia, quisquam voluptas. Vel repellat
          debitis magnam culpa magni? Veritatis doloribus adipisci odit. Totam
          iusto quidem libero!
        </p>
      ...
      <div className="lg:col-span-2 flex justify-between mt-6">
        <div>
          ...
          <ul>
            ...
            <li className="py-2 text-sm">Coommerce</li>
        ...
        <div>
          ...
          <ul>
            ...
            <li className="py-2 text-sm">Oportunidaeds</li>
            <li className="py-2 text-sm">Assessoria</li>
          </ul>
        </div>
        <div>
          <h6 className="font-medium text-gray-400">Legalizado</h6>
          <ul>
            <li className="py-2 text-sm">Contato</li>
